---
name: om:status
description: "Use to check task execution progress, run status, completion statistics. Triggers on STATUS intent: check progress, how's it going, what's left, or execution overview. DO NOT trigger on: development tasks, debugging, or starting new tasks."
---
