---
name: om:resume
description: "Use to resume interrupted task execution. Triggers on RESUME intent: continue interrupted task, resume paused execution, or recover from session interruption. Auto-detects feature-session.json or state.json. DO NOT trigger on: new tasks, debugging, or status checks."
priority: high
---
