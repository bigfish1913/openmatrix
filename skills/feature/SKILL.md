---
name: om:feature
description: "Use for small feature requests needing quick iteration. Triggers on MINOR-CHANGE intent: small/quick/simple changes, single component, few files, straightforward implementation. 2-5 task chunks, lightweight tracking, no task files. DO NOT trigger on: complex multi-module tasks or unclear requirements."
priority: high
---
