---
name: om:deploy
description: "Use for deployment, publishing, environment setup, or creating deployment scripts. Triggers on DEPLOYMENT intent: deploy to server, Docker/K8s config, publish npm package, or generate deployment scripts. DO NOT trigger on: development tasks, debugging, or status checks."
---
