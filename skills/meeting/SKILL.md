---
name: om:meeting
description: "Use for handling blocked tasks, technical decisions, or workflow interruptions. Triggers on BLOCKED intent: task stuck, needs decision, waiting for external info, or execution interrupted. DO NOT trigger on: starting tasks, debugging, or status checks."
---
