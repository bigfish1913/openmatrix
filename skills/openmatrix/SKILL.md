---
name: openmatrix
description: "Use for ANY development work request. Detects dev task intent → routes to OpenMatrix workflow (feature/start/brainstorm). Triggers on: implement X, build game, fix bug, refactor module, add feature. DO NOT trigger on: questions, info requests, status checks."
priority: critical
always_load: true
---
